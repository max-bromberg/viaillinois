 ...
 *
 * `doc/` is excluded. It holds retained CS411 course documents, which are
 * historical records rather than living text, and editing them would falsify
 * the record.
 *
...
const EM_DASH = '\u2014';
const EN_DASH = '\u2013';
const EXCLUDED_PREFIXES = ['doc/'];

/** Tracked files, minus excluded directories. */
